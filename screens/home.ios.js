    ...
    if(this.state.dataLoaded){
        return (
          <ScrollView>
            ...
            <LinearGradient colors={['rgba(0,114,255,1)','rgba(0,132,255,1)']} style={{padding : 10,borderRadius : 5}}>
            <View>
            <DateComponent/>
            <GridRow columns={2}>
            ...
            <Button color="#00b894" title="Add new task" onClick={() => this.props.navigation.navigate('NewTask',{
        uid : this.state.uid
      })}></Button>
            </View>
            </LinearGradient>
